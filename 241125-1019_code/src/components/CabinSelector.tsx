...
import { Wifi, Zap, BedDouble, WifiOff, ZapOff } from 'lucide-react';
...
const BED_SIZES = {
  ...
  '4-Bed Dorm': '90×200cm (35×79") - Single',
...
export function CabinSelector({
  ...
  const visibleAccommodations = accommodations
    .filter(acc => {
      ...
      const isGlamping = ['Tipi', 'Bell Tent'].some(type => acc.title.includes(type));
      if (isGlamping) {
